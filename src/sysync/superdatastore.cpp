...
bool TSuperDataStore::engHandleAlertStatus(uInt16 aStatusCode)
{
...
void TSuperDataStore::engAbortDataStoreSync(uInt16 aStatusCode, bool aLocalProblem, bool aResumable)
{
  // abort subdatastores
  TSubDSLinkList::iterator pos;
  for (pos=fSubDSLinks.begin();pos!=fSubDSLinks.end();pos++) {
