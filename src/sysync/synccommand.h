...
public:
  ...
  TStatusCommand *newStatusCommand(uInt16 aStatusCode, const char *aStringItem=NULL);
  // properties
...
protected:
  ...
  void issueStatusCommand(uInt16 aStatusCode);
...
public:
  ...
  TUnimplementedCommand(
    ...
    uInt16 aStatusCode=406             // status code to be returned on execution (default = unimplemented option 406)
  );
...
public:
  ...
  TStatusCommand(
    ...
    uInt16 aStatusCode=0               // status code
  );
  ...
  // - set Status code
  void setStatusCode(uInt16 aStatusCode);
  ...
  // properties
  // - get status code
  uInt16 getStatusCode(void) { return fStatusCode; };
...
protected:
  ...
  // info
  uInt16 fStatusCode;  // status code
