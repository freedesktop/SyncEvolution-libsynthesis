...
protected:
  ...
  uInt16 fLastItemStatus;               ///< final status sent for last item in previously suspended session.
...
public:
  ...
  static localstatus getSyncModeFromAlertCode(uInt16 aAlertCode, TSyncModes &aSyncMode, bool &aIsSlowSync, bool &aIsServerAlerted);
  ...
  virtual void engAbortDataStoreSync(uInt16 aReason, bool aLocalProblem, bool aResumable=true);
  ...
  SUPERDS_VIRTUAL bool engHandleAlertStatus(uInt16 aStatusCode);
...
protected:
  ...
  virtual void dsAbortDatastoreSync(uInt16 aStatusCode, bool aLocalProblem) {}; // nop here
