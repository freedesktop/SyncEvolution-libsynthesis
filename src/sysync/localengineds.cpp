...
bool TLocalEngineDS::engHandleAlertStatus(uInt16 aStatusCode)
{
  bool handled=false;
  #ifdef SYSYNC_CLIENT
...
void TLocalEngineDS::engAbortDataStoreSync(uInt16 aStatusCode, bool aLocalProblem, bool aResumable)
{
